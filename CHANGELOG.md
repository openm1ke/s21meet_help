...
### 26.11.23
- исправлен парсинг ивентов
- исправлена ошибка отображения времени последней активности профиля
### 06.11.23
- теперь список активных проектов обновляется по нажатию на кнопку "проекты"
- исправлен баг вывода клавиатуры для проектов (спасибо esylva)

### 26.10.23
- исправлена ошибка назначения меню команд

### 23.10.23
- исправлена ошибка при регистрации. добавлена проверка на уже зарегистрированный логин

### 20.10.23
- исправлена ошибка при выводе списка пиров, работающих над одним проектом. теперь выводятся первые 20 пиров.
